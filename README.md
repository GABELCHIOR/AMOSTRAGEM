...
a versão pré-print que circula em PDF; publicado pela Blucher em 2005). Começa
pelo capítulo 1 (o planejamento de um levantamento, sem fórmulas) e pelo
capítulo 2 (a formalização: população, amostra, plano amostral, distribuição
amostral), que são a base de todos os planos dos capítulos seguintes.
