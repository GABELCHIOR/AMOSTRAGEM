#!/usr/bin/env python
"""
Localiza as regioes de figura numa pagina do PDF de Bolfarine & Bussab.
...
O cap. 1 tem tres figuras (a 1.1 na PDF p. 22; a 1.2 e a 1.3 sao arvores em
\put do TeX, que nao viram caixa). Quando o resultado
